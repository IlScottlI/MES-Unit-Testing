...
module.exports = {
    LBF_1_10: async function (obj) {
        ...
        let test_case = {
            ...
            test_case: "Filtering based on task",
            step: "LBF-1.10",
            step_description: "1.Enter serial number  2.Click on load machine  3.Click on any department  4. Click on workCenter 5. Click on checkbox for the task to be filter.",
