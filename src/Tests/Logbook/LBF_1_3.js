...
module.exports = {
    LBF_1_3: async function (obj) {
        ...
        let test_case = {
            ...
            test_case: "Enter Invalid serial number",
            step: "LBF-1.3",
            step_description: "1.Enter serial number (Invalid-enter) 2. Click on load machine or press Enter key",
            dependencies: "Invalid serial number",
            role: "User",
        ...
        await puppeteer.launch({
            ...
            // 1. Enter serial number (Invalid-enter)  
            await page.waitForSelector('[data-component-path="C$0:0$0:0.0:1"]');
            await page.type('[data-component-path="C$0:0$0:0.0:1"]', '123456789');
            ...
            // Validate 
            if (case_1 == '⚠ This Machine Serial Number / Tracking Number Does Not Exist...') {
                // Capture Results
